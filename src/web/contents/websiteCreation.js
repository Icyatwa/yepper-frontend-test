...
import apiClient, { setupApiInterceptors } from '../../utils/apiClient';
...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await apiClient.post('/api/websites', formData, {
        headers: {
      ...
      if (error.response?.status === 401) {
        ...
        errorMessage = 'Website URL already exists. Please use a different URL.';
