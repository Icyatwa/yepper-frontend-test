      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
                ...
                <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <Text className="font-medium">{selectedCategories.length} ad space(s) selected</Text>
                    </div>
                    <div className="flex items-center gap-2">
                      <Text className="font-semibold">Total: ${totalCost}</Text>
                    </div>
                  </div>
                </div>
              )}
        ...
        <div className="border-t border-gray-200 pt-8 text-center">
          <Button 
            ...
            variant="secondary"
            size="lg"
            icon={selectedCategories.length > 0 ? CreditCard : null}
            iconPosition="left"
          >
            {isSubmitting ? 'Creating Ad...' : selectedCategories.length > 0 ? `Continue to Payment ($${totalCost})` : 'Select Ad Spaces to Continue'}
          </Button>
        </div>
      </div>
    </div>
